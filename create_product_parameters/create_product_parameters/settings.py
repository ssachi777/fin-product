"""
Django settings for create_product_parameters project.
...
ROOT_URLCONF = 'create_product_parameters.urls'
...
WSGI_APPLICATION = 'create_product_parameters.wsgi.application'
